...
const getLessonsByStudentId = "SELECT l.date, l.student_id, CONCAT(t.first_name, ' ', t.last_name) AS teacher_name FROM lessons AS l JOIN teachers AS t ON t.id = l.teacher_id WHERE DATE(l.date) >= CURRENT_DATE AND l.student_id = $1 ORDER BY l.date ASC";
